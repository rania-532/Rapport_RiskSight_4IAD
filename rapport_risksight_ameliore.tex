...
\vspace*{1.5cm}
{\color{black}\large\textsc{\'Ecole Marocaine des Sciences de l 'Ing\'enieur}\\[0.2cm]
{\color{black}\normalsize Fili\`ere : Ing\'enieurie Informatique et R\'eseau option: IA \& D --- 4\textsuperscript{e} Ann\'ee}}
...
\begin{tcolorbox}[enhanced,colback=white,colframe=primary,
  ...
  \centering
  {\Huge\bfseries\color{primary} RiskSight}\\[0.3cm]
  {\large\color{secondary}\rule{8cm}{1.5pt}}\\[0.3cm]
...
\textbf{[Nom du Professeur]}, pour sa disponibilité, ses conseils avisés
...
une marge sur coût variable de 98\% et un résultat net Year~1 estimé à
888~900~DH pour 19~clients pilotes.
\vspace{8cm}
...
is reached at just three clients, with a 98\% variable cost margin and an
estimated Year-1 net result of 888,900 DH for 19 pilot clients.
\vspace{8cm}
...
[Compl\'etez ce paragraphe en d\'ecrivant le contexte macro\'economique marocain,
...
Ma\^itrise d'Ouvrage (MOA)
  ...
  & {[Nom de l'\'etablissement / porteur]} \\
\midrule
...
\begin{tabularx}{\linewidth}{>{\bfseries\color{primary}}p{3.5cm} X}
  ...
  Porteur (MOA)     & {[Nom de l'\'etablissement]} \\
...
[D\'ecrivez ici comment les institutions financi\`eres marocaines g\`erent
...
[Listez les limites des solutions actuelles~: absence de localisation marocaine,
...
march\'e cible de 200+~structures. La marge sur co\^ut variable (\textbf{98\%})
...
\includegraphics[width=\textwidth]{wbs_risksight.png}
...
[D\'ecrivez chaque table (fait\_demande\_credit, dim\_client, dim\_temps,
...
[D\'ecrivez les \'etapes de cr\'eation de la BDD AtlasCreditBank dans SSMS.
...
[D\'ecrivez la configuration des connexions Source CSV (code page 65001 UTF-8)
...
[R\'edigez ici un bilan complet~: rappel de la probl\'ematique, r\'esum\'e des
...
\begin{itemize}
  ...
  \item Faisabilit\'e \'economique prouv\'ee (SR = 3~clients, marge $\approx$98\%).
\end{itemize}
...
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{>{\bfseries}p{3cm} p{2cm} X p{4.5cm}}
\toprule
\rowcolor{primary!12}
